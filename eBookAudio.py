...
# Replace 'mbrola-us1' with the desired voice ID
#engine.setProperty('voice', 'mbrola-us1')

# Set properties - Festival specific settings
engine.setProperty('voice', 'festival')


engine.setProperty('volume', 0.7)  # Volume level (0.0 to 1.0)
...
engine.save_to_file(textx, filenamex + '.wav')  # Save as WAV file
engine.runAndWait()

file_path = filenamex + '.wav' #"path/to/your/file.txt"
...
if os.path.exists(file_path):
    ...
    print("File exists! Continuing with the next line of code.")

# Convert WAV to MP3
sound = AudioSegment.from_wav(filenamex + '.wav')
sound.export(filenamex + '.mp3', format='mp3')

# Play the generated audio
play(sound) # Copy and paste your work, or start typing.